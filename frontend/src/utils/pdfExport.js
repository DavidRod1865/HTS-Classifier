...
export const exportToPDF = (results, productDescription, claudeAnalysis = '') => {
...
export const exportToHTMLReport = (results, productDescription, claudeAnalysis = '') => {
  const formatDate = () => {
    return new Date().toLocaleDateString('en-US', {
      year: 'numeric',
      month: 'long',
...
<body>
    ...
    ${claudeAnalysis ? `<div class="section">
        <div class="section-title">Analysis & Recommendations</div>
        <div class="bg-gray-50 rounded-lg p-4 border">
            <pre class="whitespace-pre-wrap text-sm text-gray-700 font-sans leading-relaxed">${claudeAnalysis}</pre>
        </div>
    </div>` : ''}
